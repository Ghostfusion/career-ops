...
## [1.33.0](https://github.com/Ghostfusion/career-ops/compare/career-ops-v1.32.0...career-ops-v1.33.0) (2026-09-13)
...
* **data-root:** five more scripts resolved the checkout where the data root was meant ([e21b34c](https://github.com/Ghostfusion/career-ops/commit/e21b34cb7dd84286d4a383e457870a4b01e8f6bd))
...
* **garena:** route id encoding through _safe-url so one bad posting drops, not the page ([7bee848](https://github.com/Ghostfusion/career-ops/commit/7bee8480f4a3571d47fd9b2ba888122a21e52c0c))
...
* **invite-match:** resolve set-status.mjs from the code root, not the data root ([cfc6b01](https://github.com/Ghostfusion/career-ops/commit/cfc6b0190eac5a1c919aefeb28a008a97b4d8864))
* **invite-match:** resolve set-status.mjs from the code root, not the data root ([5c65257](https://github.com/Ghostfusion/career-ops/commit/5c652575fd43e818ee0f1be7dc0aff646a3e773e))
...
* **ledger:** tolerate CRLF in the proof-point ledger ([e3afd22](https://github.com/Ghostfusion/career-ops/commit/e3afd22424a0c2271060e7fcd49a40f8ddefc62e))
...
* **pdf:** gate batch renders, and give cover letters the workspace output root ([c62f13f](https://github.com/Ghostfusion/career-ops/commit/c62f13f82f61f6ec3bfbf26c18a20aae29c86259))
...
* **providers:** a lone surrogate in one id/slug no longer aborts the whole page ([7cdd684](https://github.com/Ghostfusion/career-ops/commit/7cdd6845278948b4d8379fb2fcebf39304e54994))
* **providers:** a lone surrogate in one id/slug no longer aborts the whole page ([d76bea0](https://github.com/Ghostfusion/career-ops/commit/d76bea0e1c3f9a8f3aab20ce583812774ceda23c))
...
* **providers:** coerce before the try; drop tkms encode of the config locale ([94eebce](https://github.com/Ghostfusion/career-ops/commit/94eebced04e524572e201ee65df275a60f370771))
...
* **providers:** route feishu-jobs and mokahr id encoding through _safe-url ([fd3966a](https://github.com/Ghostfusion/career-ops/commit/fd3966aa50fbe8e2b603cf6a226c8b8ae777f3e1))
...
* **rheinmetall:** guard the slug-fallback decode against a malformed percent-escape ([6efda1c](https://github.com/Ghostfusion/career-ops/commit/6efda1c1003188d70a1323685d44fd3882e6c3ed))
...
* **sync-hunks:** defects inside the fork's own hunks to shared scripts ([94fd4ae](https://github.com/Ghostfusion/career-ops/commit/94fd4ae2d4cc9dba86892d671b0ff38534331e42))
...
* **tkms:** re-encode the config locale, hoisted out of the row loop to fail loud ([5b8f1f0](https://github.com/Ghostfusion/career-ops/commit/5b8f1f0d6cf5900c1cc557bd9c391239801fe4ff))
...
* **tools:** audit fixes across the fork toolkit ([ddd9e16](https://github.com/Ghostfusion/career-ops/commit/ddd9e160b197a8289ff359b5991056284463e715))
* **tools:** read user-layer files through the data root, not the cwd or code root ([290d4c7](https://github.com/Ghostfusion/career-ops/commit/290d4c702ff0a8fe956d4eba15578b34e6eecf60))
